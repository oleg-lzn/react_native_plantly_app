  ...
  return (
    <View style={styles.detailsContainer}>
      <View style={{ alignItems: "center" }}>
        ...
        <Text style={styles.value}>{plant.wateringFrequency} days</Text>
        <Text style={styles.key}>Last watered at</Text>
        <Text style={styles.value}>
          {plant.isWateredAtTimestamp
            ? `${format(plant.isWateredAtTimestamp, fullDateFormat)}`
            : "Never 😟"}
        </Text>
        <Text style={styles.key}>Days since last watered</Text>
        <Text style={styles.value}>
          {plant.isWateredAtTimestamp
            ? differenceInCalendarDays(Date.now(), plant.isWateredAtTimestamp)
            : "N/A"}
        </Text>
      </View>
